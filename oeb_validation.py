...
key_differences = {}
for energy_type, data_tree in [("electricity", electricity_data_tree), ("natural_gas", natural_gas_data_tree)]:
	# Grab the respective energy keys
	energy_keys = [element.tag for element in data_tree.findall('BillDataRow' if energy_type == "electricity" else 'GasBillData')[0]]
